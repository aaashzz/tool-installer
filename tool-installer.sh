...
declare -a array=("git" "stegcracker" "wpscan" "smbclient" "smbmap" "curl" "wget" "nmap" "vim" "whatweb" "gobuster" "binwalk" "wfuzz" "hydra" "john" "hashcat" "aircrack-ng" "evil-winrm" "steghide" "recon-ng" "whois" "twint" "reaver" "metasploit" "exploitdb" "nikto" "netdiscover" "seclists" "webshells" "openvpn")
